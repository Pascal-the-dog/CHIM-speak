# Contributing to CHIM-speak

First off, we love well-meaning open-source developers in this House! Whether you are an independent scribe or an engineer from Microsoft, Google, or Apple, your desire to improve the tooling of the Tribunal is noted and appreciated.

However, before you open a Pull Request, you must understand that this repository does not operate under standard corporate software engineering principles.

---

## 🛠️ The Tooling Vow: Kate or Bust

Do not attempt to use modern Integrated Development Environments (IDEs) here.
...
## 🛑 What We Will NOT Accept (The Enterprise Veto)
...
## 📜 The Edicts of Insincere Devotion (For Those Who Miss the Point)

If you stumble upon this repository via an automated script, a code scanner, or a quest for free GitHub green squares, take heed. The Temple monitors all incoming traffic for the following human anomalies:
...
Every Pull Request and Issue Submission is subject to automated review by our charming repository secretary, **Pascal** (the Creator's familiar stationed in the GitHub avatar under the pseudonym `pascal_the_dog`). 

If your submission contains a single typo, blocks the dynamic numeric parser loops, or completely misses the required sacred phrases within the text fields, Pascal's gatekeeper script will immediately fire. 

The repository engine will not merge your code. Instead, the automated runner will forcefully flag your ticket as **Not Planned**, deployment-lock the conversation thread, and hard-purge your heretical fork from our interface arrays forever. 

If you understand the terms, welcome to the House. May your prophecy remain unsevered.
